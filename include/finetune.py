...
class DatasetCollector:
    def __init__(self, needs_dev_team_output_path: str = DEFAULT_NEEDS_DEV_TEAM_OUTPUT_PATH):
    ...
    def collect_needs_dev_team_output(self, issue: Issue, actual_decision: bool, additional_info: str):
        with open(self.needs_dev_team_output_path, "a") as f:
            self.__write_jsonl_newline(f, issue=issue.description, actual_decision=actual_decision, additional_info=additional_info)
